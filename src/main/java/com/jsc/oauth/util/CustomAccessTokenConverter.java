...
/**
 * The type Custom access token converter.
 */
@Component
public class CustomAccessTokenConverter implements AccessTokenConverter, JwtAccessTokenConverterConfigurer {
    ...
    /**
     * Sets user token converter.
     *
     * @param userTokenConverter the user token converter
     */
    ...
    /**
     * Sets include grant type.
     *
     * @param includeGrantType the include grant type
     */
